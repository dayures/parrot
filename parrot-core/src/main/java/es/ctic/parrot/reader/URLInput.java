...
public class URLInput implements Input {
    ...
    private static final String ACCEPT_HEADER_VALUES = "application/rdf+xml;application/xml;application/rif+xml;application/owl+xml;text/x-rif-ps;application/xhtml+xml;text/n3;*/*"; // FIXME: add other mimetypes
    private static final Set<String> STRICT_MIMETYPES = new HashSet<String>(Arrays.asList("application/rdf+xml","application/xml","application/rif+xml","application/owl+xml","text/x-rif-ps", "application/xhtml+xml", "text/n3"));
