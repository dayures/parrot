...
public interface DetailView {
	...
	/**
	 * Returns the anchor generated by the MD5 hash of the URI, or <code>null</code> if the element has no URI. 
	 * @return the anchor generated by the MD5 hash of the URI, or <code>null</code> if the element has no URI.
	 */
	public abstract String getAnchorFromUriMD5();
}
